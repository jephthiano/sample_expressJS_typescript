...
const encrypt = (data) => cryptoJS.AES.encrypt(data, cryptoJS.enc.Utf8.parse(key), { iv: cryptoJS.enc.Utf8.parse(iv) }).toString();
const decrypt = (data) => cryptoJS.AES.decrypt(data, cryptoJS.enc.Utf8.parse(key), { iv: cryptoJS.enc.Utf8.parse(iv) }).toString(cryptoJS.enc.Utf8);
...
export { hashPassword, verifyPassword, selEncrypt, selDecrypt, validateInput, validatePin, validatePassword, generateUniqueToken, generateUniqueId };
